  ...
  return (
    <Container section firstSection size="md">
      ...
      <PageQuote>
        ...
        environment that is accredited by the Western Association of Schools and
        Colleges, and the Council of International Schools.
      </PageQuote>

      <article className="md:columns-2 gap-12 space-y-8">
        <PageParagraph>
          The Mitra Kasih Early Years academic program is based on The Creative
          Curriculum® for preschool, a comprehensive early childhood
          educational system that has been shown to promote cognitive, physical,
          social/emotional, and language development of children.
        </PageParagraph>
        ...
        <PageParagraph>
          ...
          standards, practices and results for student learning. We place strong
          emphasis on language arts and mathematics. To ensure a balanced
          curriculum, we provide programs in science and technology, social
          studies, modern language, fine arts and physical development.
        </PageParagraph>

        <PageParagraph>
          The Mitra Kasih Middle School curriculum emphasizes research-based
          teaching and learning practices through age-appropriate intellectual,
        ...
        <PageParagraph>
          Based on international standards, the Mitra Kasih High School academic
          program is designed to prepare students for a university that fits
          them best. It includes options to take the International Baccalaureate
          (IB) and Advanced Placement (AP) diploma/courses. The more options
          students have to find the right path for them, the more success they

    ...
    <Container section firstSection size="md">
      ...
      <Container>
        <article className="mt-10">
          ...
          <ul className="list-disc">
            ...
            <li>
              Penilaian dan tes masuk nursery, kindergarten, primary,middle,
              high school mengikuti ketentuan sekolah.
            </li>
            <li>
          ...
          <ul className="list-disc">
            ...
            <li>
              Foto copy ijazah dilegalisir((berlaku untuk Primary, Middle, &
              High School) 1 lembar
            </li>
          </ul>
          {/* </PageParagraph> */}
        </article>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
        ...
        <Link
          target="_blank"
          className="w-full"
          href="https://smp.mitrakasih.sch.id/public/register/student"
        >
        ...
        <Link
          target="_blank"
          className="w-full"
          href="https://sma.mitrakasih.sch.id/public/register/student"
        >
